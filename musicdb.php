    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#Home">Home<span class="sr-only">(current)
          </span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="musicdb/account.php">Account</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="musicdb/search.php">Search Music</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="musicdb/playlists.php">Playlists</a>
        </li>
     </ul>
    </div>
  </nav>
